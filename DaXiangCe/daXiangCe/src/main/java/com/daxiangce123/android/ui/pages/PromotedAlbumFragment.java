 ...
 * @author Ram
 */
public class PromotedAlbumFragment extends NearbyAlbumFragment implements OnClickListener, OnItemClickListener {
	...
	protected void initData() {
		ConnectBuilder.listHotAlbum(HotType.PROMOTED, Consts.LIST_HOT_ALBUM_PRO);
	...
	protected void initBroadCast() {
		...
		ift.addAction(Consts.LIST_HOT_ALBUM_PRO);
	...
	protected void onGetNearbyAlbums(ConnectInfo info, Response response) {
		...
		// Utils.sortByDistance(alumList.getList(), false);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		UMutils.instance().diyEvent(ID.EventClickPromotedAlbum);
