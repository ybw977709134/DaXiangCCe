    ...
    private Bitmap tryLoadBitmap() throws TaskCancelledException {
        ...
        try {
            ...
            if (imageFile != null && imageFile.exists()) {
                ...
                if (uri != null && Scheme.ofUri(uri) == Scheme.FILE) {
                    String path = Scheme.FILE.crop(uri);
                    if (App.DEBUG) {
                        LogUtil.d(TAG, "isVideo=" + FileUtil.isVideo(uri));
                    }
                    if (FileUtil.isVideo(uri)) {
                        return BitmapUtil.getVideoThumb(path, targetSize.getWidth(), targetSize.getHeight());
                    }
                    return decodeImage(uri);
                }
            }
        ...
        //TODO OOM Exception has been disabled
